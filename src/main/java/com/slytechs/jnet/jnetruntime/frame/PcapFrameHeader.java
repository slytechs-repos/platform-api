 ...
 * the License.
 */
package com.slytechs.jnet.jnetruntime.frame;
...
public class PcapFrameHeader extends MemoryBinding implements FrameHeader {
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#asBuffer()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#asSegment()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#captureLength()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#captureLength(int)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#timestamp()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#timestamp(long,
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#timestamp(com.slytechs.jnet.jnetruntime.time.TimestampUnit)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#wireLength()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.frame.FrameHeader#wireLength(int)
	 */
	@Override
