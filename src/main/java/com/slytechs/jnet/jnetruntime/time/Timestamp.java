...
public class Timestamp extends Date implements TimestampPrecisionInfo, StringBuildable {
	 ...
	 * @see com.slytechs.jnet.jnetruntime.time.TimestampPrecisionInfo#precisionTimeUnit()
	 */
	@Override
	 ...
	 *
	 * @return the int
	 * @see com.slytechs.jnet.jnetruntime.time.TimestampPrecisionInfo#precision()
	 */
	@Override
