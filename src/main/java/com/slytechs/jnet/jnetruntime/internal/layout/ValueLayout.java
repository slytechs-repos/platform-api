...
import com.slytechs.jnet.jnetruntime.internal.layout.BinaryLayout.HasDataCarrier;
...
public abstract class ValueLayout extends AbstractLayout implements HasDataCarrier {
	...
	public static class OfAddress extends ValueLayout {
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnet.jnetruntime.internal.layout.BinaryLayout#carrierSize()
		 */
		@Override
	 ...
	 *
	 * @return the class
	 * @see com.slytechs.jnet.jnetruntime.internal.layout.BinaryLayout.HasDataCarrier#carrierType()
	 */
	@Override
	 ...
	 *
	 * @return the long
	 * @see com.slytechs.jnet.jnetruntime.internal.layout.BinaryLayout.HasDataCarrier#carrierOffset()
	 */
	@Override
