...
import com.slytechs.jnet.jnetruntime.util.Numberable;
...
public class MemoryNumberable implements Numberable {
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.Numberable#as(java.lang.Class)
	 */
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.Numberable#asUnsigned(java.lang.Class)
	 */
	@Override
