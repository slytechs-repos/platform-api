...
public interface BitField extends BinaryField, Constable {
	...
	public interface Proxy  extends BitField {
		 ...
		 * @param data the data
		 * @return the double
		 * @see com.slytechs.jnet.jnetruntime.internal.layout.BitField#getDouble(java.lang.Object)
		 */
		@Override
		 ...
		 * @param data the data
		 * @return the float
		 * @see com.slytechs.jnet.jnetruntime.internal.layout.BitField#getFloat(java.lang.Object)
		 */
		@Override
		 ...
		 * @param data  the data
		 * @return the double
		 * @see com.slytechs.jnet.jnetruntime.internal.layout.BitField#setDouble(double,
		 *      java.lang.Object)
		 */
		@Override
		 ...
		 * @param data  the data
		 * @return the float
		 * @see com.slytechs.jnet.jnetruntime.internal.layout.BitField#setFloat(float,
		 *      java.lang.Object)
		 */
		@Override
		 ...
		 * @param data  the data
		 * @return the long
		 * @see com.slytechs.jnet.jnetruntime.internal.layout.BitField#setLong(int,
		 *      java.lang.Object)
		 */
		@Override
