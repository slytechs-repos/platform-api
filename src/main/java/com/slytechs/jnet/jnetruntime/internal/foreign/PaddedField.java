...
import com.slytechs.jnet.jnetruntime.internal.foreign.struct.StructMemberName;
...
public interface PaddedField {
	...
	public class ToStructuredField implements PaddedField {
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnet.jnetruntime.internal.foreign.PaddedField#bitAlignment()
		 */
		@Override
