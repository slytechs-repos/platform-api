...
public interface ArrayField extends BinaryField {
	...
	public interface Proxy extends ArrayField {
		 ...
		 * @see com.slytechs.jnet.jnetruntime.internal.layout.ArrayField#getByteArrayAt(long,
	...
	class FormattedArrayField implements ArrayField.Proxy {
		 ...
		 * @param sequences the sequences
		 * @return the string
		 * @see com.slytechs.jnet.jnetruntime.internal.layout.ArrayField.Proxy#toString(java.lang.Object,
		 *      long[])
		 */
		@Override
