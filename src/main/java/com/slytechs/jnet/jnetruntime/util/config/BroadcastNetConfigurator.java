...
public class BroadcastNetConfigurator implements NetConfigurator {
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.config.NetConfigurator#applyConfigChanges(com.slytechs.jnet.jnetruntime.util.config.NetConfig)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.config.NetConfigurator#applyPropertyChanges(com.slytechs.jnet.jnetruntime.util.config.NetConfig,
	 *      com.slytechs.jnet.jnetruntime.util.config.NetProperty, java.lang.Object,
	 *      java.lang.Object)
	 */
	@SuppressWarnings({
			"unchecked",
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.config.NetConfigurator#name()
	 */
	@Override
	public String name() {
		return name;
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.config.NetConfigurator#registerConfigListener(com.slytechs.jnet.jnetruntime.util.config.NetConfig,
	 *      com.slytechs.jnet.jnetruntime.util.config.NetConfigurator.NetConfigChange)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.config.NetConfigurator#registerConfigListener(java.lang.String,
	 *      com.slytechs.jnet.jnetruntime.util.config.NetConfigurator.NetPropertyChange)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.config.NetConfigurator#onPropertyChange(com.slytechs.jnet.jnetruntime.util.config.NetProperty,
	 *      com.slytechs.jnet.jnetruntime.util.config.NetConfigurator.NetPropertyChange)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.config.NetConfigurator#registerAllPropertyListeners(java.lang.Object,
	 *      com.slytechs.jnet.jnetruntime.util.config.NetProperty[])
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetruntime.util.config.NetConfigurator#applyAllFieldPropertySetters(java.lang.Object,
	 *      com.slytechs.jnet.jnetruntime.util.config.NetProperty[])
	 */
	@Override
