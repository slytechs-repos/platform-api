...
import com.slytechs.jnet.platform.api.internal.layout.BinaryLayout.HasDataCarrier;
...
public abstract class ValueLayout extends AbstractLayout implements HasDataCarrier {
	...
	public static class OfAddress extends ValueLayout {
		 ...
		 * @see com.slytechs.jnet.platform.api.internal.layout.BinaryLayout#withBitAlignment(long)
		 */
		@Override
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnet.platform.api.internal.layout.BinaryLayout#carrierSize()
		 */
		@Override
	 ...
	 *
	 * @return the class
	 * @see com.slytechs.jnet.platform.api.internal.layout.BinaryLayout.HasDataCarrier#carrierType()
	 */
	@Override
	 ...
	 *
	 * @return the long
	 * @see com.slytechs.jnet.platform.api.internal.layout.BinaryLayout.HasDataCarrier#carrierOffset()
	 */
	@Override
