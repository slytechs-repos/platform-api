...
public interface BinaryLayout {
	...
	public interface Proxy extends BinaryLayout {
		 ...
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#whenEnabled(boolean)
		 */
		@Override
		 ...
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#isEnabled()
		 */
		@Override
		 ...
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#arrayField(java.lang.String)
		 */
		@Override
		 ...
		 *
		 * @return the int
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#bitAlignment()
		 */
		@Override
		 ...
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#bitField(com.slytechs.jnet.platform.api.memory.layout.Path[])
		 */
		@Override
		 ...
		 * @param path the path
		 * @return the bit field
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#bitField(java.lang.String)
		 */
		@Override
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#bitSize()
		 */
		@Override
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#byteAlignment()
		 */
		@Override
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#byteSize()
		 */
		@Override
		 ...
		 *
		 * @return the optional
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#layoutName()
		 */
		@Override
		 ...
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#size()
		 */
		@Override
		 ...
		 * @return the binary layout
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#withBitAlignment(int)
		 */
		@Override
		 ...
		 * @param name the name
		 * @return the binary layout
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#withName(java.lang.String)
		 */
		@Override
		 ...
		 * @param elements the elements
		 * @return the array field
		 * @see com.slytechs.jnet.platform.api.memory.layout.BinaryLayout#arrayField(com.slytechs.jnet.platform.api.memory.layout.Path[])
		 */
		@Override
