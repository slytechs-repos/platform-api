...
class BitOperatorShifter implements BitOperator {
	 ...
	 *
	 * @return the long
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#bitmask(long,
	 *      long)
	 */
	@Override
	public long bitmask() {
	 ...
	 * @return the int
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#bitshift(long,
	 *      long)
	 */
	@Override
	 ...
	 * @param strideOffset the stride offset
	 * @return the int
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#getIntAtOffset(java.lang.Object,
	 *      int, long, long)
	 */
	@Override
	 ...
	 * @param strideOffset the stride offset
	 * @return the int
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#setIntAtOffset(int,
