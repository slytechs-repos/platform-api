...
class BitOperatorNop implements BitOperator {
	 ...
	 *
	 * @return the long
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#bitmask(long, long)
	 */
	@Override
	public long bitmask() {
	 ...
	 * @return the int
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#bitshift(long, long)
	 */
	@Override
	 ...
	 * @param strideOffset the stride offset
	 * @return the byte
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#getByteAtOffset(java.lang.Object,
	 *      byte, long, long)
	 */
	@Override
	 ...
	 * @param strideOffset the stride offset
	 * @return the int
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#getIntAtOffset(java.lang.Object, int,
	 *      long, long)
	 */
	@Override
	 ...
	 * @param strideOffset the stride offset
	 * @return the long
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#getLongAtOffset(java.lang.Object,
	 *      long, long, long)
	 */
	@Override
	 ...
	 * @param strideOffset the stride offset
	 * @return the short
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#getShortAtOffset(java.lang.Object,
	 *      short, long, long)
	 */
	@Override
	 ...
	 * @param strideOffset the stride offset
	 * @return the byte
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#setByteAtOffset(byte,
	 ...
	 * @param strideOffset the stride offset
	 * @return the int
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#setIntAtOffset(int, java.lang.Object,
	 *      int, long, long)
	 */
	@Override
	 ...
	 * @param strideOffset the stride offset
	 * @return the long
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#setLongAtOffset(long,
	 ...
	 * @param strideOffset the stride offset
	 * @return the short
	 * @see com.slytechs.jnet.platform.api.memory.layout.BitOperator#setShortAtOffset(short,
