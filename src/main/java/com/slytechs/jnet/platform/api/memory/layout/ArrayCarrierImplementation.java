...
class ArrayCarrierImplementation implements ArrayCarrier {
	 ...
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#getByteArrayAtOffset(byte[],
	 ...
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#getIntArrayAtOffset(int[],
	 *      int, int, java.lang.Object, long)
	 */
	@Override
	 ...
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#getLongArrayAtOffset(long[],
	 *      int, int, java.lang.Object, long)
	 */
	@Override
	 ...
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#getShortArrayAtOffset(short[],
	 *      int, int, java.lang.Object, long)
	 */
	@Override
	 ...
	 * @param byteOffset the byte offset
	 * @return the byte[]
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#setByteArrayAtOffset(byte[],
	 *      int, int, java.lang.Object, long)
	 */
	@Override
	 ...
	 * @param byteOffset the byte offset
	 * @return the int[]
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#setIntArrayAtOffset(int[],
	 *      int, int, java.lang.Object, long)
	 */
	@Override
	 ...
	 * @param byteOffset the byte offset
	 * @return the long[]
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#setLongArrayAtOffset(long[],
	 *      int, int, java.lang.Object, long)
	 */
	@Override
	 ...
	 * @param byteOffset the byte offset
	 * @return the short[]
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#setShortArrayAtOffset(short[],
	 *      int, int, java.lang.Object, long)
	 */
	@Override
	 ...
	 * @see com.slytechs.jnet.platform.api.memory.layout.ArrayCarrier#wrapAtOffset(byte[],
	 *      long, long)
	 */
	@Override
