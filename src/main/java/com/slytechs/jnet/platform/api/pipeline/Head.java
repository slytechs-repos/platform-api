...
import com.slytechs.jnet.platform.api.pipeline.InputTransformer.InputMapper;
import com.slytechs.jnet.platform.api.pipeline.InputTransformer.InputMapper.SimpleInputMapper;
...
public class Head<T> extends Processor<T> {
	...
	/**
	 * @see com.slytechs.jnet.platform.api.pipeline.Processor#getOutput()
	 */
	@Override
	public T getOutput() {
		if (outputData == null)
	...
	/**
	 * @see com.slytechs.jnet.platform.api.pipeline.Processor#setOutput(java.lang.Object)
	 */
	@Override
