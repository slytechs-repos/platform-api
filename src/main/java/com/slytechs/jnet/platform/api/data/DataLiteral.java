...
public class DataLiteral<T> implements DataType<T> {
	...
	/**
	 * @see com.slytechs.jnet.platform.api.data.DataType#arrayAllocator()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.platform.api.data.DataType#dataClass()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.platform.api.data.DataType#empty()
	 */
	@Override
	public T empty() {
		return empty;
	...
	/**
	 * @see com.slytechs.jnet.platform.api.data.DataType#name()
	 */
	@Override
	public String name() {
		return name;
	...
	/**
	 * @see com.slytechs.jnet.platform.api.data.DataType#wrapArray(java.lang.Object[])
	 */
	@Override
