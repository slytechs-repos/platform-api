...
public class FormattedBitField implements BitField.Proxy {
	...
	public interface ValueFormatter<T> {
		...
		public interface OfLong extends ValueFormatter<Long> {
			 ...
			 * @return the object
			 * @see com.slytechs.jnet.platform.api.internal.layout.FormattedBitField.ValueFormatter#formatObject(java.lang.Object)
			 */
			@Override
	 ...
	 * @param sequences the sequences
	 * @return the string
	 * @see com.slytechs.jnet.platform.api.internal.layout.BitField.Proxy#toString(java.lang.Object,
	 *      long[])
	 */
	@Override
