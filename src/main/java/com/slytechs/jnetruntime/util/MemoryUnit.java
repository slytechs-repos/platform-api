 ...
 * the License.
 */
package com.slytechs.jnetruntime.util;

import java.math.BigInteger;

import com.slytechs.jnetruntime.util.UnitUtils.ConvertableUnit;
...
public enum MemoryUnit implements ConvertableUnit<MemoryUnit>, Unit {
	...
	/**
	 * @see com.slytechs.jnetruntime.util.Unit#toBase(long)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnetruntime.util.Unit#getSymbols()
	 */
	@Override
