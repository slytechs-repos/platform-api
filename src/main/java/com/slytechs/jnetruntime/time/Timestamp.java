 ...
 */
package com.slytechs.jnetruntime.time;
...
import com.slytechs.jnetruntime.util.Detail;
import com.slytechs.jnetruntime.util.StringBuildable;
...
public class Timestamp extends Date implements TimestampPrecisionInfo, StringBuildable {
	 ...
	 * Instantiates a new timestamp.
	 *
	 * @param timestampSource the timestamp source
	 */
	public Timestamp(HasTimestamp timestampSource) {
		this(timestampSource.timestamp(), timestampSource.timestampUnit());
	}
	 ...
	 * @see com.slytechs.jnetruntime.time.TimestampPrecisionInfo#precisionTimeUnit()
	 */
	@Override
	 ...
	 *
	 * @return the int
	 * @see com.slytechs.jnetruntime.time.TimestampPrecisionInfo#precision()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetruntime.util.StringBuildable#buildString(java.lang.StringBuilder,
	 *      Detail)
	 */
	@Override
