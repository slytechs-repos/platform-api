...
public class RebasedTimestampSource implements TimestampSource {
	 ...
	 *
	 * @return the long
	 * @see com.slytechs.jnetruntime.time.TimestampSource#timestamp()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnetruntime.time.TimestampSource#init(long)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnetruntime.time.TimestampSource#update(long)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnetruntime.time.TimestampSource#isRealtime()
	 */
	@Override
