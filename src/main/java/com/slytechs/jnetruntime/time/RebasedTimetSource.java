...
public class RebasedTimetSource implements TimeSource.Updatable {
	...
	/**
	 * @see com.slytechs.jnetruntime.time.TimeSource.Updatable#initialize(long)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnetruntime.time.TimeSource.Updatable#update(long)
	 */
	@Override
	 ...
	 *
	 * @return the long
	 * @see com.slytechs.jnetruntime.time.TimeSource#timestamp()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnetruntime.time.TimeSource#timeUnit()
	 */
	@Override
