 ...
 * the License.
 */
package com.slytechs.jnetruntime.internal.foreign;

import java.lang.foreign.MemoryLayout;

import com.slytechs.jnetruntime.internal.foreign.struct.StructMemberName;
...
public interface PaddedField {
	...
	public class ToStructuredField implements PaddedField {
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnetruntime.internal.foreign.PaddedField#bitAlignment()
		 */
		@Override
