...
import com.slytechs.jnetruntime.internal.layout.BinaryLayout.HasDataCarrier;
import com.slytechs.jnetruntime.internal.layout.Path.PathKind;
import com.slytechs.jnetruntime.util.Bits;
...
public abstract class ValueLayout extends AbstractLayout implements HasDataCarrier {
	...
	public static class OfAddress extends ValueLayout {
		 ...
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#withBitAlignment(long)
		 */
		@Override
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#carrierSize()
		 */
		@Override
	 ...
	 *
	 * @return the class
	 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout.HasDataCarrier#carrierType()
	 */
	@Override
	 ...
	 *
	 * @return the long
	 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout.HasDataCarrier#carrierOffset()
	 */
	@Override
