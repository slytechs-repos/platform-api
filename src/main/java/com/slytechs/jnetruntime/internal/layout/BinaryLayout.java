...
public interface BinaryLayout {
	...
	public interface Proxy extends BinaryLayout {
		 ...
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#whenEnabled(boolean)
		 */
		@Override
		 ...
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#isEnabled()
		 */
		@Override
		 ...
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#arrayField(java.lang.String)
		 */
		@Override
		 ...
		 *
		 * @return the int
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#bitAlignment()
		 */
		@Override
		 ...
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#bitField(com.slytechs.jnetruntime.internal.layout.Path[])
		 */
		@Override
		 ...
		 * @param path the path
		 * @return the bit field
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#bitField(java.lang.String)
		 */
		@Override
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#bitSize()
		 */
		@Override
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#byteAlignment()
		 */
		@Override
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#byteSize()
		 */
		@Override
		 ...
		 *
		 * @return the optional
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#layoutName()
		 */
		@Override
		 ...
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#size()
		 */
		@Override
		 ...
		 * @return the binary layout
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#withBitAlignment(int)
		 */
		@Override
		 ...
		 * @param name the name
		 * @return the binary layout
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#withName(java.lang.String)
		 */
		@Override
		 ...
		 * @param elements the elements
		 * @return the array field
		 * @see com.slytechs.jnetruntime.internal.layout.BinaryLayout#arrayField(com.slytechs.jnetruntime.internal.layout.Path[])
		 */
		@Override
