 ...
 * the License.
 */
package com.slytechs.jnetruntime.internal.util;

import java.lang.foreign.Arena;
import java.lang.foreign.MemorySegment;
import java.nio.ByteBuffer;

import com.slytechs.jnetruntime.MemoryBinding;
...
public interface Attribute  {
	...
	public enum Builtin implements Attribute {
		 ...
		 *
		 * @return the int
		 * @see com.slytechs.jnetruntime.internal.util.Attribute#family()
		 */
		@Override
		public int family() {
			return 0;
	...
	public interface Value {
		...
		default MemorySegment getMemorySegment() {
			return getMemorySegment(Arena.ofAuto());
		}
		 ...
		 * @return the memory segment
		 */
		MemorySegment getMemorySegment(Arena scope);
		...
		default <T extends MemoryBinding> T getObject(T obj) {
			return getObject(obj, Arena.ofAuto());
		}
		 ...
		 * @return the object
		 */
		default <T extends MemoryBinding> T getObject(T obj, Arena session) {
