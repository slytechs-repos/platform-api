...
public class ArrayListLong extends AbstractList<Long> implements ListLong {
	 ...
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#addLong(int)
	 */
	@Override
	 ...
	 * @param c the c
	 * @return true, if successful
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#addAllLongs(com.slytechs.jnetruntime.internal.util.collection.LongCollection)
	 */
	@Override
	 ...
	 * @param e the e
	 * @return true, if successful
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#containsLong(int)
	 */
	@Override
	 ...
	 * @param c the c
	 * @return true, if successful
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#containsAllLongs(com.slytechs.jnetruntime.internal.util.collection.LongCollection)
	 */
	@Override
	 ...
	 * @param c the c
	 * @return true, if successful
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#removeAllLongs(com.slytechs.jnetruntime.internal.util.collection.LongCollection)
	 */
	@Override
	 ...
	 * @return true, if successful
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#removeLongIf(java.util.function.LongPredicate)
	 */
	@Override
	 ...
	 * @param c the c
	 * @return true, if successful
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#retainAllLongs(com.slytechs.jnetruntime.internal.util.collection.LongCollection)
	 */
	@Override
	 ...
	 *
	 * @return the long[]
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#toLongArray()
	 */
	@Override
	 ...
	 * @return the long[]
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#toLongArray(int[])
	 */
	@Override
	 ...
	 * @return the long[]
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#toLongArray(java.util.function.LongFunction)
	 */
	@Override
	 ...
	 *
	 * @return the of long
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#iterator()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetruntime.internal.util.collection.LongCollection#intStream()
	 */
	@Override
	 ...
	 * @param index the index
	 * @param e     the e
	 * @see com.slytechs.jnetruntime.internal.util.collection.ListLong#addLong(int, int)
	 */
	@Override
	 ...
	 * @param c     the c
	 * @return true, if successful
	 * @see com.slytechs.jnetruntime.internal.util.collection.ListLong#addAllLongs(int,
	 *      com.slytechs.jnetruntime.internal.util.collection.LongCollection)
	 */
	@Override
	 ...
	 * @param e the e
	 * @return the int
	 * @see com.slytechs.jnetruntime.internal.util.collection.ListLong#indexOfLong(int)
	 */
	@Override
	 ...
	 * @param e the e
	 * @return the int
	 * @see com.slytechs.jnetruntime.internal.util.collection.ListLong#lastIndexOfLong(int)
	 */
	@Override
	 ...
	 * @param index the index
	 * @return the long
	 * @see com.slytechs.jnetruntime.internal.util.collection.ListLong#removeLong(int)
	 */
	@Override
	 ...
	 * @param e     the e
	 * @return the long
	 * @see com.slytechs.jnetruntime.internal.util.collection.ListLong#set(int, int)
	 */
	@Override
