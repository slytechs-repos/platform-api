 ...
 * the License.
 */
package com.slytechs.jnetruntime.internal.util.format;

import java.nio.ByteBuffer;
import java.util.Optional;
import java.util.function.Function;

import com.slytechs.jnetruntime.internal.util.ByteArraySlice;
...
public interface FormatProperty {
	...
	public interface OfByteArray extends FormatProperty {
		 ...
		 *
		 * @return the object
		 * @see com.slytechs.jnetruntime.internal.util.format.FormatProperty#value()
		 */
		@Override
