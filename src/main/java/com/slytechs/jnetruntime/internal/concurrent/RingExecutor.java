 ...
 * the License.
 */
package com.slytechs.jnetruntime.internal.concurrent;

import java.util.concurrent.Exchanger;
import java.util.concurrent.TimeUnit;
import java.util.concurrent.TimeoutException;

import com.slytechs.jnetruntime.internal.util.collection.LinkedListSupport;
...
public class RingExecutor<T> {
	...
	static class Entry<T>
		 ...
		 * @return the t
		 * @throws InterruptedException the interrupted exception
		 * @see com.slytechs.jnetruntime.internal.concurrent.RingExecutor.ResourceStatus#await()
		 */
		@Override
		 ...
		 * @return the t
		 * @throws InterruptedException the interrupted exception
		 * @see com.slytechs.jnetruntime.internal.concurrent.RingExecutor.ResourceStatus#await(long,
