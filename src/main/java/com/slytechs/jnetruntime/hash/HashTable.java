 ...
 * the License.
 */
package com.slytechs.jnetruntime.hash;
...
public class HashTable<T> implements KeyedTable<T> {
	...
	public static class HashEntry<T> implements Entry<T> {
		 ...
		 *
		 * @return the t
		 * @see com.slytechs.jnetruntime.hash.KeyedTable.Entry#data()
		 */
		@Override
		public T data() {
			return data;
		 ...
		 *
		 * @return the int
		 * @see com.slytechs.jnetruntime.hash.KeyedTable.Entry#index()
		 */
		@Override
		public int index() {
			return index;
	 ...
	 * @see com.slytechs.jnetruntime.hash.KeyedTable#get(int)
	 */
	@Override
	 ...
	 * @param key the key
	 * @return the int
	 * @see com.slytechs.jnetruntime.hash.KeyedTable#lookup(java.nio.ByteBuffer)
	 */
	@Override
	 ...
	 * @param key the key
	 * @return true, if successful
	 * @see com.slytechs.jnetruntime.hash.KeyedTable#remove(java.nio.ByteBuffer)
	 */
	@Override
